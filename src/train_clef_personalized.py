# src/train_clef_personalized.py
...
from models.clef_personalized_head import CLEFPersonalizedHead
...
def train():
    ...
    best_ckpt_path = models_dir / "clef_personalized_best.pt"
